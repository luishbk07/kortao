...
export type RecordatorioCitaEmailProps = PropsEmailCitaBase & {
  enlaceGoogleCalendar: string | null
}

export const RecordatorioCitaEmail = ({
  clienteNombre,
  negocioNombre,
  negocioLogoUrl,
  fechaFormateada,
      ...
      <Body style={estilosEmail.body}>
        <Container style={estilosEmail.contenedor}>
          ...
          <Text style={estilosEmail.parrafo}>
            ...
            <span style={estilosEmail.destacado}>{negocioNombre}</span> el{' '}
...
RecordatorioCitaEmail.PreviewProps = {
  clienteNombre: 'María',
...
} satisfies RecordatorioCitaEmailProps

export default RecordatorioCitaEmail
